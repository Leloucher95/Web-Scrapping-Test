...
imp    async def _extract_quotes_from_page(self, page: Page, quotes_selector: str = '.bqQt') -> List[Dict]:
        ...
        logger.info(f"Processing {len(quote_elements)} quote elements with selector '{quotes_selector}'")io
import logging
